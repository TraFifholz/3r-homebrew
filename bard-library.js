...
const filters = [...document.querySelectorAll("#bard-filters .filter")];
...
const emptyState = document.querySelector("#bard-empty");
const clearButton = document.querySelector("#clear-bard");
let category = "全部";
...
function render() {
  ...
  resultCount.textContent = visible === entries.length ? `共 ${entries.length} 首` : `找到 ${visible} 首 · 共 ${entries.length} 首`;

...
const baseSource = (await readFile(new URL("../sources/feats-prestige.txt", import.meta.url), "utf8")).replace(/^\uFEFF/, "").replace(/\r\n?/g, "\n");
const investigatorSource = (await readFile(new URL("../sources/investigator-prestige.txt", import.meta.url), "utf8")).replace(/^\uFEFF/, "").replace(/\r\n?/g, "\n");
const source = `${baseSource.trimEnd()}\n\n${investigatorSource.trim()}\n`;
...
const definitions = [
  ...
  { name: "调查员（Investigator）", marker: "调查员（Investigator）", table: "表：调查员进阶职业", columns: ["等级", "基本攻击加值", "强韧", "反射", "意志", "特殊能力", "灵感点", "每日奥术／显能"] },
];
...
<html lang="zh-CN"><head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta name="theme-color" content="#16130f" /><meta name="description" content="D&D与Pathfinder中文规则资料：八个完整进阶职业。" /><meta property="og:title" content="进阶职业｜3R Homebrew" /><meta property="og:description" content="八个结构化整理的完整进阶职业。" /><meta property="og:type" content="article" /><meta property="og:url" content="https://trafifholz.github.io/3r-homebrew/prestige-classes.html" /><meta name="twitter:card" content="summary" /><title>进阶职业｜3R Homebrew</title><link rel="icon" href="assets/favicon.svg" type="image/svg+xml" /><link rel="stylesheet" href="styles.css" /><script src="catalog-library.js" defer></script></head>
<body data-unit="项"><header class="site-header"><a class="brand" href="index.html"><span class="brand-mark" aria-hidden="true">3R</span><strong>Homebrew</strong></a><nav aria-label="主导航"><a href="index.html">扩展技法</a><a href="feats.html">专长</a><a href="cleric-variants.html">牧师</a><a href="scout-rework.html">斥候</a><a href="ranger-update.html">巡林客</a><a href="rogue-update.html">游荡者</a><a href="bard-movements.html">诗人</a><a href="soulknife.html">魂刃</a><a href="prestige-classes.html" aria-current="page">进阶职业</a><a href="harrowing.html">法术</a><a href="equipment.html">装备</a><a href="https://github.com/TraFifholz/3r-homebrew" target="_blank" rel="noreferrer">GitHub ↗</a></nav></header><main><section class="library section-shell ranger-library" id="library" aria-labelledby="library-title"><div class="section-heading library-heading"><div><p class="eyebrow">职业资料 · 8个完整进阶职业</p><h2 id="library-title">进阶职业</h2></div><p id="result-count" role="status" aria-live="polite">共 8 项</p></div><div class="toolbar scout-toolbar" aria-label="进阶职业筛选工具"><label class="search-box"><span class="sr-only">搜索进阶职业</span><span aria-hidden="true">⌕</span><input id="search" type="search" placeholder="搜索职业、进阶条件、能力或等级表…" autocomplete="off" /><kbd>/</kbd></label></div><section class="scout-section" data-section="prestige"><h3>进阶职业 <span>8</span></h3><div class="scout-entries">${entriesHtml}</div></section><div class="empty-state" id="catalog-empty" hidden><p class="empty-glyph" aria-hidden="true">∅</p><h3>没有找到对应资料</h3><p>试试缩短关键词。</p><button class="button button-ghost" id="clear-catalog" type="button">清除筛选</button></div></section></main></body></html>`;

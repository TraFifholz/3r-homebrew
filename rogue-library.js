...
const filters = [...document.querySelectorAll("#rogue-filters .filter")];
const entries = [...document.querySelectorAll(".scout-entry")];
const sections = [...document.querySelectorAll(".scout-section")];
const resultCount = document.querySelector("#result-count");
const emptyState = document.querySelector("#rogue-empty");
const clearButton = document.querySelector("#clear-rogue");
let category = "全部";
